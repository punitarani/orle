...
> **⚠️ Raycast** The extension is waiting to be published in the store ([PR #23925](https://github.com/raycast/extensions/pull/23925)). For now, you can locally access it by running `bun run raycast:dev`
