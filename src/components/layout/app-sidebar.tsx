...
export function AppSidebar() {
  ...
  const isCustomSectionActive = pathname.startsWith("/tools/custom/");
  ...
  return (
    <>
                    ...
                    <SidebarMenuSub>
                      ...
                      <SidebarMenuSubItem>
                        <Button
                          variant="ghost"
                          size="sm"
                          className="w-full justify-start gap-2 h-7 px-2 text-primary hover:text-primary"
                        ...
                        return (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={(e) =>
                                handleDeleteCustomTool(e, tool.id)
                              }
      ...
      <ToolGenerator open={generatorOpen} onOpenChange={setGeneratorOpen} />
    </>
  );
}
